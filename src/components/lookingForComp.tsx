  ...
  return (
    <div className='w-full h-full flex flex-col items-center justify-center my-20 '  >
      <div className='flex flex-col   bg-orange-600 gap-10 p-4 border-2 border-orange-600 rounded-3xl' >
        ...
        <form className='flex gap-20 bg-white px-16 py-10 border-4 border-white rounded-3xl '  >
          ...
          <div className='flex flex-col gap-2' >
            ...
            <div className='flex gap-2' >
              <input type='number' onChange={(e)=>{}} min={18} value={18} placeholder='Enter Age Range From' className=' p-2 py-3 rounded-2xl border border-gray-600 ' />
              <span className='flex items-center justify-center mx-2 ' >to</span>
              <input type='number' onChange={(e)=>{}}  max={100} value={100} placeholder='Enter Age Range To' className=' p-2 py-3 rounded-2xl border border-gray-600 ' />
            </div>
          </div>
